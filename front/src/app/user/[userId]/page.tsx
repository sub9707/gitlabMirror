    ...
    <div id='pageContainer'>
      <div className={styles.pageContainer}>
        <div className={styles.bannerBack}>
          <Lottie loop animationData={Ballon} play style={{ width: '30vh', height: '30vh', marginTop: '-3.3%' }} />
        </div>
          ...
          <div className={styles.sideProfile}>
            <div>
              ...
              <p className={`${styles.boxTitle} ${styles.username}`}>
                {userInfo?.username}
                {userInfo?.userId === parseInt(localStorage.getItem('userId') as string, 10) && (
                  <KeyIcon onClick={() => onClickKey(userInfo?.extensionKey as string)} />
                )}
                <p className={styles.tooltip}>
                  <p>
                    크롬 확장 프로그램 <span>Repomon Battle Device</span>의 <br />
              ...
              <Link href={`https://github.com/${userInfo?.username.toLowerCase()}`} target='_blank'>
            ...
            {userInfo?.representRepo == null || !userInfo.representRepo.isActive ? (
              ...
              <div className='flex flex-col pt-10'>
                ...
                <div className={`flex flex-col relative items-center border rounded-full overflow-hidden bg-white ${styles['repomon-div']}`}>
