...
function Page() {
  ...
  const [isExtensionNavOpened, setIsExtensionNavOpened] = useState<boolean>(true);
  ...
  function extensionNavToggle() {
    setIsExtensionNavOpened(!isExtensionNavOpened);
  }
  ...
  return (
    <div className={`${styles.docsDiv} flex `}>
      ...
      <div className={`${styles.navDiv} `}>
        ...
        {/* Extension */}
        <div>
          <div className={`${styles.navBarListItem} flex`} onClick={extensionNavToggle}>
            {isExtensionNavOpened ? <ChevronDownIcon width='1rem' /> : <ChevronRightIcon width='1rem' />}
            <div className={`ps-2`}>
              <a className='text-lg font-bold'>Extension</a>
            </div>
          </div>
          {isExtensionNavOpened ? (
            <>
              <a href='#ExtensionInstall'>
                <div className={`${styles.navBarItem} flex`}>
                  <div className='border-r-2' style={{ paddingLeft: '17px' }}></div>
                  <p>Extension 설치</p>
                </div>
              ...
              <a href='#ExtensionKey'>
                <div className={`${styles.navBarItem} flex`}>
                  <div className='border-r-2' style={{ paddingLeft: '17px' }}></div>
                  <p>Extension Key 발급</p>
                </div>
              </a>
              <a href='#ExtensionDocs'>
                <div className={`${styles.navBarItem} flex`}>
                  <div className='border-r-2' style={{ paddingLeft: '17px' }}></div>
                  <p>Extension 사용법</p>
                </div>
      ...
      {/* 바디 */}
      <div className={`${styles.descriptionDiv} border-l grow`}>
        {/* 레포지터리 */}
        <div id='Repository' className={`${styles.menu} border-b pt-8 pb-5`}>
          ...
          <div id='RepositoryRenew' className={`${styles.menuItem} pb-5`}>
            ...
            <div>
              ...
              <div>
                <img className='ms-5 border-4 my-2' src='/static/images/docs_repo_reload.png' alt='x' style={{ height: '200px' }}></img>
              </div>
            </div>
          </div>
          <div id='RepositoryActive' className={`${styles.menuItem} pb-5`}>
            ...
            <div>
              ...
              <div>
                <img className='ms-5 border-4 my-2' src='/static/images/docs_repo_active.png' alt='x' style={{ height: '200px' }}></img>
              </div>
            </div>
          </div>
          <div id='RepositoryCreateRepomon' className={`${styles.menuItem} pb-5`}>
            ...
            <div>
              ...
              <div>
                <img className='ms-5 border-4 my-2' src='/static/images/docs_repomon_create_01.png' alt='x' style={{ height: '200px' }}></img>
              </div>
              <li>
        ...
        <div id='Card' className={`${styles.menu} border-b pt-8 pb-5`}>
          ...
          <div id='UserCard' className={`${styles.menuItem} pb-5`}>
            ...
            <div>
              ...
              <li>
                내 프로필 페이지에서 <strong>Export User Card</strong>버튼을 클릭합니다. (모달창 팝업에는 일정시간이 소요될 수 있습니다.)
              </li>
              <li>
                모달창에서 레포지토리를 분석하여 선택된 사용언어 리스트에서 표시할 <strong>사용언어를 선택하고 적용</strong>합니다.
              </li>
              <li>
                하단에 예시로 보여지는 <strong>card를 클릭하면 URL을 복사</strong>할 수 있습니다.
              </li>
              <li>
                복사된 URL 을 <strong>Markdown</strong> 파일에서 사용합니다.
              </li>
              <div>
                <img className='ms-5 my-2' src='https://repomon.kr/card/user' alt='x' style={{ height: '200px' }}></img>
              </div>
            </div>
          </div>
          <div id='RepoTeamCard' className={`${styles.menuItem} pb-5`}>
            ...
            <div>
              ...
              <li>
                모달창의 선택바에서 <strong>레포카드</strong>를 선택합니다.
              </li>
              <li>
                하단에 예시로 보여지는 <strong>card를 클릭하면 URL을 복사</strong>할 수 있습니다.
              </li>
              ...
              <div>
                <img className='ms-5 my-2' src='https://repomon.kr/card/repo' alt='x' style={{ height: '200px' }}></img>
              </div>
            </div>
          </div>
          <div id='RepoRersonalCard' className={`${styles.menuItem} pb-5`}>
            ...
            <div>
              ...
              <li>
                모달창의 선택바에서 <strong>개인 레포카드</strong>를 선택합니다.
              </li>
              <li>
                모달창에서 레포지토리를 분석하여 선택된 사용언어 리스트에서 표시할 <strong>사용언어를 선택하고 적용</strong>합니다.
              </li>
              ...
              <div>
                <img className='ms-5 my-2' src='https://repomon.kr/card/repo_personal' alt='x' style={{ height: '200px' }}></img>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* 레포몬 */}
        <div id='Repomon' className={`${styles.menu} border-b pb-5 pt-8`}>
        ...
        {/* Extension */}
        <div id='Extension' className={`${styles.menu} border-b pb-5 pt-8`}>
          <p className='text-4xl  pb-5' style={{ color: `rgba(109, 130, 250, 1)`, fontWeight: '1000' }}>
            Extension
          </p>
          <div id='ExtensionInstall' className={`${styles.menuItem} pb-5`}>
            <p className='text-xl font-bold pb-3'>Extension 설치</p>
            <li>
          ...
          <div id='ExtensionKey' className={`${styles.menuItem} pb-5`}>
            <p className='text-xl font-bold py-3'>Extension Key 발급</p>
            <li>
              <strong>깃허브 로그인</strong>을 진행합니다.
            </li>
            <li>
            ...
            <li>
              내 프로필 페이지 좌측의 유저정보에서 <strong>열쇠 아이콘</strong>을 클릭합니다.
            </li>
            <li>
              <strong>복사된 Key</strong> 로 Repomon Extension 에 로그인할 수 있습니다.
            </li>
            <div>
              <img className='ms-5 border-4 my-2' src='/static/images/docs_extension_key.png' alt='x' style={{ height: '300px' }}></img>
            </div>
          </div>
          <div id='ExtensionDocs' className={`${styles.menuItem} pb-5`}>
            <p className='text-xl font-bold py-3'>Extension 사용법</p>
            <li>
              <strong>Extension을 설치</strong>합니다.
            </li>
            <li>
              <strong>Extension Key를 받급</strong>합니다.
            </li>
            <li>
              유저ID와 발급받은 Extension Key를 사용하여 <strong>Extension 에 로그인</strong>합니다.
            </li>
            <li>
              Extension 로그인에 성공하면 <strong>브라우저에서 편하게 서비스를 즐길 수 있습니다.</strong>
            </li>
            <div>
              <img className='ms-5 border-4 my-2' src='/static/images/docs_extension_example.png' alt='x' style={{ height: '400px' }}></img>
            </div>
          </div>
        </div>

        {/* 노트 */}
        <div id='Note' className={`${styles.menu}  pb-5 pt-8`}>
          <p className='text-4xl  pb-5' style={{ color: `rgba(109, 130, 250, 1)`, fontWeight: '1000' }}>
            Note
          </p>
          ...
          <div id='Tier' className={`${styles.menuItem} pb-5`}>
            ...
            <li>
              레이팅 기준 <strong>1,000점</strong> 미만은 브론즈, <strong>1,000점부터 1,199점</strong>은 실버, <strong>1,200점부터 1,399점</strong>은
              골드, <strong>1,400점부터 1,599점</strong>은 플래티넘, <strong>1,600점 이상</strong>은 다이아 로 구분됩니다. (2023.05.10 기준)
            </li>
            <li>
              현재 티어에 따라 닉네임 옆에 <strong>특정 마크</strong>가 부착됩니다.
            </li>
            <div>
              <img className='ms-5 border-4 my-2' src='/static/tier/tiers.png' alt='x' style={{ height: '100px' }}></img>
            </div>
          </div>
        </div>
